  ...
  return (
    <section className="page">
      <div className="page-head">
        <div>
          <h2>Pointage</h2>
          <p>Saisir plusieurs projets dans une même journée.</p>
        </div>
      </div>
      ...
      <div className="card">
        ...
        {entries.map((entry, index) => (
          <div className="entry-line" key={index}>
            ...
            <textarea value={entry.comment} onChange={(e) => updateEntry(index, "comment", e.target.value)} />
        ...
        <div className="total-box">Total journée : <strong>{totalDay.toFixed(2)} h</strong></div>
      </div>
    </section>
  );
}
